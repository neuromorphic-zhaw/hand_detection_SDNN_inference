...
class DHP19NetMonitor(AbstractProcess):
    def __init__(self,
        ...
        self.frame_encoded_in = InPort(shape=in_shape)
...
class DHP19NetMonitorModel(PyLoihiProcessModel):
    ...
    frame_encoded_in = LavaPyType(PyInPort.VEC_DENSE, np.int32)
    ...
    def __init__(self, proc_params=None) -> None:
        ...
        self.input_frame = plt.subplot2grid((6, 2), (0, 0), rowspan=2, colspan=2)
        self.input_encoded = plt.subplot2grid((6, 2), (2, 0), rowspan=2, colspan=2)       
        self.y1 = plt.subplot2grid((6, 2), (4, 0))
        self.x1 = plt.subplot2grid((6, 2), (4, 1))
        self.y2 = plt.subplot2grid((6, 2), (5, 0))
        self.x2 = plt.subplot2grid((6, 2), (5, 1))
    ...
    def run_spk(self) -> None:
        ...
        frame_encoded = self.frame_encoded_in.recv()
        ...
        self.input_encoded.set_title('Input Encoded ' + str(self.time_step))
        self.input_encoded.imshow(np.swapaxes(frame_encoded[:,:,0],0,1), cmap='gray')       
